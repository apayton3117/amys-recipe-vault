...
(function(){
  ...
  function ensureStyles(){
    ...
    s.textContent=`
      ...
      .recipe-time-card strong{font-family:Georgia,serif;font-size:20px;color:#493942}
      .recipe-tabs{display:flex;gap:8px;flex-wrap:wrap;border-bottom:1px solid var(--line);padding-bottom:10px;margin:20px 0 18px}
